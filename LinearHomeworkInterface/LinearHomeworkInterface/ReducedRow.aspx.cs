...
{
    public partial class ReducedRow : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Convert.ToInt32(Request.QueryString["question"]) != curQuestion)
                {
                    ...
                    Response.Redirect("ReducedRow.aspx?assign=" + Request.QueryString["assign"] + "&question=" + curQuestion);
                }
            ...
            matrix = this.Create_Problem(n, min, max);
        ...
        //method to dynamically load the Reduced Row question using MATHJAX
        ...
        public float[,] Create_Problem(int n, int min, int max)
        {
            MatrixBuilder.MatrixOperations mb = new MatrixBuilder.MatrixOperations();
                ...
                actualAnswer = mb.reduceMatrix(matrix);
